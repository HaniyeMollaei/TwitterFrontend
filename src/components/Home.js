                    ...
                    <tr class="row">
                        <td class="col-4">
                            <div id="sidebar_left">
                                ...
                                <Link to="/home">
                                    <button class="btn btn-primary menu-item">Home</button>
                                </Link>
                        ...
                        <td class="col-5" colSpan="2">
                            <div id="page_center">
                                <div class="tweet">
                                    <textarea class="form-control" id="tweet_txt" name="tweet" rows="8" cols="70"
                                              placeholder="  What's happening?"
                                              onChange={this.handle_change}></textarea>
                                    <p id="text_size"></p>
                                    <div id="tweet_size_warn"></div>
                                    <button id="send_tweet_button" class="btn btn-primary"
                                            disabled={this.state.disable_tweet}
                        ...
                        <td class="col-3">
                            <div id="sidebar_right">
                                <input id="search_txt" type="text" size="10" class="form-control"
                                       placeholder="Search Twitter" onClick={e => this.sendTweet(e, this.state)}
                                       name="search"></input>
                            </div>
                        </td>
                    </tr>
